...
// /**Register but with username and password only*/
//    protected static void registerUser(String username, String password) {
//        if (hasConnected) {
//            if (tableName == null) {
//                setTableName();
//            }
...
//                    .append(" VALUES (")
//                    .append(id)
//                    .append(", DEFAULT, DEFAULT, ?, ?, ?)"); //DEFAULT | id + 1 -> method to find the gap
//            try {
//                preparedStatement = connection.prepareStatement(sql.toString());
//                preparedStatement.setString(1, username); //username
//                preparedStatement.setString(2, password); //password
//                preparedStatement.setString(3, "no"); //admin //checkbox
//
//                preparedStatement.execute();
//                accounts.put(username, password);
//                System.out.println("User Registered Successfully!");
...
//            if(accounts.get(str[2]).equals(str[3])){
